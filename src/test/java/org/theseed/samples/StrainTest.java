...
public class StrainTest {
    ...
    public void test() {
        ...
        assertThat(strain1.isConstructed(), equalTo(true));
        assertThat(strain2.isConstructed(), equalTo(true));
        ...
        assertThat(strain3.isConstructed(), equalTo(true));
        assertThat(strain2.isConstructed(), equalTo(true));
        ...
        assertThat(sample1.isConstructed(), equalTo(false));
    }
