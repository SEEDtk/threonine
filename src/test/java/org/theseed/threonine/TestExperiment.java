...
public class TestExperiment {
    ...
    public void test() throws IOException {
        ...
        assertThat(exp.getResult("E10", 24.0).getGrowth(), closeTo(2.04, 0.005));
        assertThat(exp.getResult("E10", 12.0), nullValue());
        assertThat(exp.getResult("B8", 24.0).getGrowth(), closeTo(1.55, 0.005));
        assertThat(exp.getResult("C2", 24.0).getGrowth(), closeTo(5.08, 0.005));
        ...
        assertThat(exp.getResult("C2", 24.0).getGrowth(), closeTo(5.08, 0.005));
        assertThat(exp.getResult("B9", 24.0).getGrowth(), equalTo(0.0));
        assertThat(exp.getResult("B9", 4.5).getGrowth(), closeTo(0.30, 0.005));
        growthFile = new File("data", "E1.1/set E1 5.5 hrs 072320.csv");
        exp.readGrowthFile(growthFile, 5.5);
        assertThat(exp.getResult("B9", 24.0).getGrowth(), equalTo(0.0));
        assertThat(exp.getResult("B9", 4.5).getGrowth(), closeTo(0.30, 0.005));
        assertThat(exp.getResult("B9", 5.5).getGrowth(), closeTo(0.38, 0.005));
        exp.removeBadWells();
        assertThat(exp.getResult("H8", 24.0), nullValue());
        assertThat(exp.getResult("E10", 24.0).getGrowth(), closeTo(2.04, 0.005));
        assertThat(exp.getResult("E10", 12.0), nullValue());
